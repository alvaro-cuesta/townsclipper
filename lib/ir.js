...
const irToBitString = (ir) => {
  ...
  outString = posBitLengthBits + outString
  outString = xDeltaBitLengthBits + outString
  outString = yOffsetBitLengthBits + outString

  annotatedString = '>' + annotatedString
  annotatedString = `po=${posBitLengthBits}[${escape(posBitLength)}]` + annotatedString
  annotatedString = `dx=${xDeltaBitLengthBits}[${escape(xDeltaBitLength)}] ` + annotatedString
  annotatedString = `+y=${yOffsetBitLengthBits}[${escape(yOffsetBitLength)}] ` + annotatedString
  annotatedString = '<' + annotatedString
  ...
  if (posBitLength > 0) {
    ...
    outString = xInitialBits + outString
    outString = yInitialBits + outString

    annotatedString = '> ' + annotatedString
    annotatedString = `x=${xInitialBits}[${escape(ir.xInitial)}]` + annotatedString
    annotatedString = `y=${yInitialBits}[${escape(ir.yInitial)}] ` + annotatedString
    annotatedString = '<' + annotatedString
  }
